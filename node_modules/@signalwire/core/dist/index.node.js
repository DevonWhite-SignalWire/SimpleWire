...
var BaseSession = class {
  ...
  _onSocketClose(event) {
    ...
    this._status = event.code == 1e3 || event.code == 1002 ? "disconnected" : "reconnecting";
...
function* sessionAuthErrorSaga(options) {
  ...
  try {
    ...
    yield (0, import_effects5.call)([session, session.disconnect]);
  } finally {
    if (yield (0, import_effects5.cancelled)()) {
...
var rootSaga_default = (options) => {
  return function* root({
    ...
    while (true) {
      const action = yield (0, import_effects5.take)([initAction.type, reauthAction.type]);
